...
public abstract class AtpStoreSearcher<V> {
    ...
    public static <T extends AtpStoreSearcher<?>> T getSearcher(Class<T> searcherType) {
        try {
    ...
    // デフォルトはidのみ
    public AtpStoreSearcher<V> fetchAllAttributes(boolean fetchAllAttributes) {
        this.fetchAllColumns = fetchAllAttributes;
        return this;
    }

    public AtpStoreSearcher<V> setSearchStrategy(AtpStoreSerchStrategy strategy) {
